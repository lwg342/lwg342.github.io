...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3935142a1986cb7fd30976d168bcfa784258393398309f6ee3aafb615503f77d.js',function(){input.required=false;search();});}
