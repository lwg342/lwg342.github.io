...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2451b00314db0f912066d56c896a17e3563597a351cd83f69902ee0f817d03a3.js',function(){input.required=false;search();});}
