...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1a5bed87a6b66a57fa35b30213598de04253878c542a286fb7bc009d61325b60.js',function(){input.required=false;search();});}
