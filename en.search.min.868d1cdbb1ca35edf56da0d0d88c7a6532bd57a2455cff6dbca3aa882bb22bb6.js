...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8c06851298f088b63d7affaa978b36360ddaf22a8957bf96487d4a58d7fd0f60.js',function(){input.required=false;search();});}
